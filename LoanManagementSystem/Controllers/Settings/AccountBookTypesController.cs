...
namespace LoanManagementSystem.Controllers.Settings
{
    public class AccountBookTypesController : Controller
    {
        ...
        {
            return View(db.sdtoAccountBookTypes.ToList());
        }
        ...
        public ActionResult Details(long? id)
        {
            ...
            sdtoAccountBookType sdtoAccountBookType = db.sdtoAccountBookTypes.Find(id);
        ...
        public ActionResult Create([Bind(Include = "AccountBookTypeId,AccountBookType,Status")] sdtoAccountBookType sdtoAccountBookType)
        {
            ...
            {
                db.sdtoAccountBookTypes.Add(sdtoAccountBookType);
                db.SaveChanges();
        ...
        {
            sdtoAccountBookType sdtoAccountBookType = db.sdtoAccountBookTypes.Find(id);
            db.sdtoAccountBookTypes.Remove(sdtoAccountBookType);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
